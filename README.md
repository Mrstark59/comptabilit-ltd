...
## 📂 Organisation (menu « Comptabilité »)

- **📊 Bilan** : résumé de la semaine — CA Factures, CA Essence, Dépenses (hors salaires), Bénéfice estimé.
- **🧾 Factures** : tableau de toutes les entrées d'argent (Magasin / Essence).
- **💸 Dépenses** : tableau des sorties. Chaque ligne a un menu déroulant de catégorie
  (*Matière première* / *Salaire*). ⚠️ Les **salaires sont exclus** du total Dépenses du Bilan.
- **📝 Notes de frais** : déclarées par les salariés (Raison + Montant), validées par l'admin.

## 📋 Données d'un embed Discord

| Champ    | Description                                  |
|----------|----------------------------------------------|
| Type     | `entrée` (→ Facture) ou `sortie` (→ Dépense) |
